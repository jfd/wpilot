 ...
 */
World.prototype.check_collisions = function(t, dt) {
...
World.prototype.remove_player = function(player_id, reason) {
  ...
  if (player.entity) {
    this.delete_entity_by_id(player.entity.id);
  }
 ...
 *  @return {undefined} Nothing
 */
World.prototype.kill_player = function(player, death_cause, killed_by) {
  player.is_dead = true;
  player.entity = null;
